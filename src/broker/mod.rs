...
/// Now supports Send + Sync for multithreading with redis 1.0.0-alpha.1 and lapin 3.6.0+
pub trait DeliveryStream:
    Stream<Item = Result<Box<dyn Delivery>, Box<dyn DeliveryError>>> + Unpin + Send + Sync
{
}
